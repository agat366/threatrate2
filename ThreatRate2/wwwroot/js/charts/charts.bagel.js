...
*/
    ...
    function getPathRaw(percentageFrom, percentage, radius, radiusIn, isAlternate) {
        ...
        var d = //"M 0,0" +  // Start at circle center
            ...
            String.format(" A {0},{1} " +
                (_opts.bars.oneItemMode ? '0 0 1 ' : isAlternate ? "0 0 0 " : "0 0 1 ") +
...
//            String.format(" L {0},{1} ", x2In, y2In) +     // Draw line to (x1,y1)
    ...
    function prepareData() {
        ...
        var sum = !_opts.bars.fullFillMode ? 1.001 : _.reduce(data, function (memo, num) { return memo + num; }, 0);
                ...
                if (_opts.bars.background) {
                    ...
                    gBackground.append('circle')
                        .attr({
                            ...
                            'fill': _opts.bars.background.fill || 'none'
                        });
                }
