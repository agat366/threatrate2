...
//                            .style({ fill: '#e9e9e9' });
                ...
                var legend = item.append('g')
                    .attr('class', 'legend-title' + (d.__marked ? ' marked': ''))
                ...
                // dots values
                var barHeightCalculated = h;// barHeight * (h / 100); // self.yScale ...
                ...
                valueContainerIn
                    ...
                    .attr('transform', self.formatTranslate(0, _opts.bars.title.dy - 45))
                ...
                valueContainerIn.append('line')
                    ...
                    .attr('x2', 16)
                    .attr('y2', -31)
                    .attr('stroke', _opts.bars.title.strokeColor)
                    .attr('stroke-width', '2');
                ...
                if (_opts.bars.title.icon) {
                    var iconContainer = valueContainerIn.append('g');
                    self.translate(iconContainer, 0, -75);
                    self.manager.renderPath(iconContainer, _opts.bars.title.icon);
                }
        });
    }
